...
// === Content styled with prose + theme
...
export default function ChapterContentLayoutSupportMDFormat() {
  ...
  return (
    <Layout>
      ...
      <Content
        ref={contentRef}
        className={`py-12 prose prose-neutral dark:prose-invert max-w-none ${fontFamily}`}
        fontSize={fontSize}
        width={width}
        contentEditable
