...
export default function ListOfChapter({ chapters, slug }: ListOfChapterProps) {
  return (
    <div
    ...
    >
      <div className="relative overflow-y-auto h-full">
        <button className="absolute top-0 right-2 cursor-pointer transition hover:opacity-70">
